...
return [
    ...
    "info" => [
        ...
        "description" =>
            "REST API untuk website desa wisata Localive. Menyediakan konten bilingual (ID/EN) meliputi UMKM, artikel, paket wisata, mitra, potensi desa, dan profil organisasi.",
    ],
    ...
    "extensions" => [\Dedoc\Scramble\Extensions\SanctumExtension::class],
